    ...
    <section class="container">
        <section class="row ml-0 mr-0 pt-8">
            <section class="col-8 offset-2 ">
                <form action="gallery/insert.php" method="post" enctype="multipart/form-data">
                    <section class="form-group">
                        <label for="caption">caption</label>
                        <textarea name="caption" id="caption" class="form-control textarea" placeholder="plz enter caption"></textarea>
                    </section>
                    <section class="form-group">
